        ...
        <div className="relative overflow-hidden rounded-sm min-h-[280px]">
          ...
          <div className="px-8 sm:px-10 pt-10 pb-6 max-w-sm">
            ...
            <p className="font-display text-xl sm:text-2xl leading-snug text-ink">
              {t.contact.quote}
              <span className="border-b-2 border-clay">{t.contact.quoteHighlight}</span>
            </p>
          </div>
        ...
        <div className="relative bg-card dark:bg-nightSurface border border-ink/10 dark:border-cream/10 rounded-sm shadow-pin px-8 sm:px-10 py-10">
          ...
          <ul className="mt-6 space-y-4 text-[13px]">
            <li className="flex items-center gap-3">
              ...
              <a href="mailto:abdelhakim.rebbouh@univ-constantine2.dz" className="hover:text-clay break-all" dir="ltr">
            ...
            <li className="flex items-center gap-3">
              <span aria-hidden>&#128247;</span>
              <a href="https://instagram.com/hakim_rebbouh" target="_blank" rel="noreferrer" className="hover:text-clay" dir="ltr">
                @hakim_rebbouh
              </a>
            </li>
          </ul>
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-3">
            <a href="mailto:abdelhakim.rebbouh@univ-constantine2.dz" className="flex-1 flex items-center justify-between bg-ink text-cream text-xs uppercase tracking-wide font-bold px-5 py-4 rounded-sm hover:bg-clay transition-colors">
              {t.contact.sayHello} <span aria-hidden>&rarr;</span>
            </a>
            <a href="/resume.pdf" download className="flex-1 flex items-center justify-between border border-ink/25 dark:border-cream/25 text-ink dark:text-cream text-xs uppercase tracking-wide font-bold px-5 py-4 rounded-sm hover:border-clay hover:text-clay transition-colors">
              {t.contact.downloadResume} <span aria-hidden>&darr;</span>
            </a>
          </div>
        </div>
      </div>
